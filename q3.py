...
##################################
### START OF YOUR CODE: Part 3 ###
##################################
def count(...):


##################################
### END OF YOUR CODE: Part 3 #####
##################################
...
if __name__ == "__main__":
  ...
  # Part 2 
    # 'vooxv' should return 5
    # 'vov' should return 3
    # 'vsoddoxv' should return 5 and print a warning 3 times
  ...
  # Part 3
    # 1: v, o, x
    # 2: v, o, x, 
    #    vv, vo, vx, ov, oo, ox, xv, xo, xx
    # 3: v, o, x, 
    #    vv, vo, vx, ov, oo, ox, xv, xo, xx, 
    #    vvv, vvo, vvx, vov, voo, vox, vxv, vxo, vxx,
    #    ovv, ovo, ovx, oov, ooo, oox, oxv, oxo, oxx,
    #    xvv, xvo, xvx, xov, xoo, xox, xxv, xxo, xxx